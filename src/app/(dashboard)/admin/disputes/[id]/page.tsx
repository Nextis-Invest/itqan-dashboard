      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              {dispute.messages.length === 0 && (
                <p className="text-neutral-500 text-sm text-center py-8">Aucun message</p>
              )}
            </div>
          </div>
        ...
        <div className="space-y-4">
          <Card className="bg-neutral-900 border-neutral-800">
            <CardHeader><CardTitle className="text-white text-sm">Mission</CardTitle></CardHeader>
            <CardContent className="space-y-2 text-sm">
              ...
              {dispute.mission.budget && (
                <div className="flex justify-between">
                  ...
                  <span className="text-white">{dispute.mission.budget} {dispute.mission.currency}</span>
                </div>
              )}
              <div className="flex justify-between">
          ...
          {dispute.mission.contract && (
            <Card className="bg-neutral-900 border-neutral-800">
              <CardHeader><CardTitle className="text-white text-sm">Contrat</CardTitle></CardHeader>
              <CardContent className="space-y-2 text-sm">
                <div className="flex justify-between">
                ...
                {dispute.mission.contract.milestones && dispute.mission.contract.milestones.length > 0 && (
                  <div className="pt-2 border-t border-neutral-800">
                    <span className="text-neutral-400 text-xs">Jalons : {dispute.mission.contract.milestones.length}</span>
                  </div>
                )}
              </CardContent>
            </Card>
          ...
          <Card className="bg-neutral-900 border-neutral-800">
            <CardHeader><CardTitle className="text-white text-sm">Litige</CardTitle></CardHeader>
            <CardContent className="space-y-2 text-sm">
              <div className="flex justify-between">
              ...
              <div className="flex justify-between">
                <span className="text-neutral-400">Assigné à</span>
                <span className="text-white">{dispute.assignedTo?.name || dispute.assignedTo?.email || "Non assigné"}</span>
              </div>
            </CardContent>
          </Card>
        </div>
