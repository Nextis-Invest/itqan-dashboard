...
export function MissionForm({ category, subcategory, categoryName, subcategoryName, locale }: MissionFormProps) {
          ...
          <div className="text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Votre mission est en cours de validation et sera bientôt visible sur la plateforme.
              </p>
            </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              name="description"
              rows={4}
              placeholder="Décrivez votre mission en détail : objectifs, livrables attendus, contexte..."
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <Input
                ...
                placeholder="Tapez et appuyez Entrée ou ,"
                className={inputCls}
              />
              <Button
                type="button"
            ...
            {skills.length > 0 && (
              <div className="flex flex-wrap gap-2 pt-2">
                {skills.map((skill) => (
                  <Badge
                    key={skill}
                    className="bg-lime-400/10 text-lime-400 border border-lime-400/20 gap-1.5 cursor-pointer hover:bg-red-400/10 hover:text-red-400 hover:border-red-400/20 transition-colors px-3 py-1.5"
